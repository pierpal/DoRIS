 ...
 */
public class SplitExpConstSymMig extends Demography {
    ...
    double expectedFraction(double[] params, double L1, double L2) {
        ...
        double G = params[5];
        double m = params[6];
        double popSelector = params[7]; // 1 if both in 1, 2 if both in 2, in two pops otherwise
        ...
        double[][] M_orig = {{1.0 - m, m}, {m, 1.0 - m}};
        double[][] M_curr = {{1.0 - m, m}, {m, 1.0 - m}};
