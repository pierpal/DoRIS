 ...
 */
public class SplitExpConstAsymMigGrid extends Grid {
    ...
    boolean donePop1Current = false, donePop2Current = false,
            ...
            doneM12 = false, doneM21 = false;
    double state[] = new double[]{0, 0, 0, 0, 0, 0, 0, -1};

    public SplitExpConstAsymMigGrid(String gridParams) throws Exception {
        ...
        while (true) {
            ...
            if (splitString[0].equalsIgnoreCase("pop1current")) {
                ...
                throw new Exception("Problem parsing grid file " + gridParams + " line starting with " + splitString[0]
                        + ". Please specify pop1current, pop1ancestral, pop2current, pop2ancestral, generation, ancestraltot, m12, m21.");
            }
        }
        if (!donePop1Current) {
